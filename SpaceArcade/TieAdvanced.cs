...
namespace SpaceArcade
{
    internal class TieAdvanced
    {
        ...
        public static float[] tieAdvanced = new float[]
            {
                 // Positions        // Colors
               ...
               -t1,         0.0f,       r1*0.6f,         colorR, colorG, colorB,             //8
               -t1,         0.0f,       -r1*0.6f,        colorR, colorG, colorB,             //9
               -t1,         r1*0.6f,    r1*0.6f*cos60,   colorR, colorG, colorB,             //10
               -t1,         r1*0.6f,    -r1*0.6f*cos60,  colorR, colorG, colorB,             //11
               -t1,         -r1*0.6f,   r1*0.6f*cos60,   colorR, colorG, colorB,             //12
               -t1,         -r1*0.6f,   -r1*0.6f*cos60,  colorR, colorG, colorB,             //13
               ...
               t1,          0.0f,       r1*0.6f,         colorR, colorG, colorB,             //20
               t1,          0.0f,       -r1*0.6f,        colorR, colorG, colorB,             //21
               t1,          r1*0.6f,         r1*0.6f*cos60,   colorR, colorG, colorB,             //22
               t1,          r1*0.6f,         -r1*0.6f*cos60,  colorR, colorG, colorB,             //23
               t1,          -r1*0.6f,        r1*0.6f*cos60,   colorR, colorG, colorB,             //24
               t1,          -r1*0.6f,        -r1*0.6f*cos60,  colorR, colorG, colorB,             //25
               ...
               // Left Wing (Advanced)
               -t1,         r2,         0.45f,      colorR, colorG, colorB,             //83
               -t1,        -r2,         0.45f,      colorR, colorG, colorB,             //84
               -t1,         r2,         -0.80f,     colorR, colorG, colorB,             //85
               -t1,        -r2,         -0.80f,     colorR, colorG, colorB,             //86

               -t1*0.75f,  0.35f,       0.35f,      colorR, colorG, colorB,             //87
               -t1*0.75f,  0.35f,       -0.70f,     colorR, colorG, colorB,             //88
               -t1*0.75f,  -0.35f,      0.35f,      colorR, colorG, colorB,             //89
               -t1*0.75f,  -0.35f,      -0.70f,     colorR, colorG, colorB,             //90

               // Right Wing (Advanced)
                t1,         r2,         0.45f,      colorR, colorG, colorB,             //91
                t1,        -r2,         0.45f,      colorR, colorG, colorB,             //92
                t1,         r2,         -0.80f,     colorR, colorG, colorB,             //93
                t1,        -r2,         -0.80f,     colorR, colorG, colorB,             //94

                t1*0.75f,  0.35f,       0.35f,      colorR, colorG, colorB,             //95
                t1*0.75f,  0.35f,       -0.70f,     colorR, colorG, colorB,             //96
                t1*0.75f,  -0.35f,      0.35f,      colorR, colorG, colorB,             //97
                t1*0.75f,  -0.35f,      -0.70f,     colorR, colorG, colorB,             //98
